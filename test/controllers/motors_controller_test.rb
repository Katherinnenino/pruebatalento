...
class MotorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create motor" do
    assert_difference("Motor.count") do
      post motors_url, params: { motor: { description: @motor.description, name: @motor.name, photo: @motor.photo, tipo: @motor.tipo } }
    end
  ...
  test "should update motor" do
    patch motor_url(@motor), params: { motor: { description: @motor.description, name: @motor.name, photo: @motor.photo, tipo: @motor.tipo } }
