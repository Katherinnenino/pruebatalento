...
class MaintenancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create maintenance" do
    assert_difference("Maintenance.count") do
      post maintenances_url, params: { maintenance: { city: @maintenance.city, fecha: @maintenance.fecha, materials: @maintenance.materials, motor_id: @maintenance.motor_id, name: @maintenance.name, operatorname: @maintenance.operatorname, tipo: @maintenance.tipo } }
    end
  ...
  test "should update maintenance" do
    patch maintenance_url(@maintenance), params: { maintenance: { city: @maintenance.city, fecha: @maintenance.fecha, materials: @maintenance.materials, motor_id: @maintenance.motor_id, name: @maintenance.name, operatorname: @maintenance.operatorname, tipo: @maintenance.tipo } }
